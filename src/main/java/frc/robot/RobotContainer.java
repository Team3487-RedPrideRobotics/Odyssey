...
public class RobotContainer {
	...
	public Command getAutonomousCommand() {
		...
		return (new TrolleyMoveCommand(-1, 1, mClimb).andThen(new WaitCommand(1))
													 .andThen(new DriveStraightCommand(-13d, 0.5, mDrive))).raceWith(new AllianceLightsCommand(mLights));
	}
