...
public class Climbing extends SubsystemBase {
	...
	private final Spark middleHook;
	private final Spark leftHook;
	private final Spark rightHook;
	...
	public Climbing() {
		...
		Shuffleboard.getTab("Climber").add(backLimitSwitch);
		elevatedHookEntry = Shuffleboard.getTab("Climber")
										.add("Invert Elevated Hooks", Constants.ClimbConstants.elevatedHookInverted)
										.withWidget(BuiltInWidgets.kToggleSwitch)
										.getEntry();
		middleHookEntry = Shuffleboard.getTab("Climber")
									  .add("Invert Sliding Hook", Constants.ClimbConstants.slidingHookInverted)
									  .withWidget(BuiltInWidgets.kToggleSwitch)
									  .getEntry();
