...
// The robot's subsystems
  public final Example mExample = new Example();
  public final Drive mDrive = new Drive();
  public final Manipulator mManipulator = new Manipulator();
  public final Climbing mClimb = new Climbing();
  public final Lights mLights = new Lights();
...
//joystick buttons
  ...
  //commands
  private final TeleopCommand mTeleopCommand = new TeleopCommand(mDrive, mManipulator, mClimb, mLights);
  ...
  public boolean getCelebrationButton() {
  ...
  public Command getAutonomousCommand() {
    ...
    return (new TrolleyMoveCommand(-1, 1, mClimb).andThen(new WaitCommand(1)).andThen(new DriveStraightCommand(-13d, 0.5, mDrive))).raceWith(new AllianceLightsCommand(mLights));
  }
