...
// auto chooser
  ...
  private final Command intakeAutoCommand = (new ShootCommand(m_manipulator, 0.95, 89).andThen(new DriveStraightCommand(-13d, 0.5, m_drive))).raceWith(new AllianceLightsCommand(m_ligts));
