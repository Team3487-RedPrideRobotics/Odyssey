...
*/
    public static int[] Parse(int angle){
        switch (angle){
            ...
            case 45: return new int[] {1, 1};
            case 90: return new int[] {1, 0};
            case 135: return new int[] {1, -1};
            case 180: return new int[] {0, -1};
            case 225: return new int[] {-1, -1};
            case 270: return new int[] {-1, 0};
            case 315: return new int[] {-1, 1};
