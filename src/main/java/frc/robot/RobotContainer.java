  ...
  */
  public Command getAutonomousCommand() {
    // The selected command will be run in autonomous
      return (new ShootCommand(m_manipulator, 0.85, 79).andThen(new DriveStraightCommand(-13d, 0.5, m_drive).raceWith((new DeployCommand(m_manipulator, ManipulatorConstants.starting_angle))))).raceWith(new AllianceLightsCommand(m_ligts));
  }
