...
public class Climbing extends SubsystemBase {
    ...
    public Climbing() {
        ...
        elevatedHooks =  new Spark(Constants.ClimbConstants.elevatedHook);
        elevatedHooks.setInverted(Constants.ClimbConstants.elevatedHookInverted);
